...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        <li>日志管理</li>
        <li class="active">修改订单价格操作日志</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="listForm" name="listForm" action="<s:url value="/admin/modifyOrderLogList.do" includeParams='none'/>" method="post">
