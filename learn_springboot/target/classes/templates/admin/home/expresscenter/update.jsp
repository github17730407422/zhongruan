...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">修改配送中心</li>
    </ul>
</div>
<div class="block s-form">
    <form class="form-horizontal" id="centerForm" action="<s:url value="/admin/centerUpdate.do" includeParams='none'/>" role="form" method="post">
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                ...
                <div class="form-group"><label class="col-sm-2 control-label text-right">配送中心位置:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" id="centerPoint" name="centerInfo.centerPoint" value="<s:property value="centerInfo.centerPoint"/>">
						      <span class="input-group-btn">
						        ...
						        <input type="hidden" id="longitude" name="centerInfo.longitude" value="<s:property value="centerInfo.longitude"/>" />
						        <input type="hidden" id="latitude" name="centerInfo.latitude" value="<s:property value="centerInfo.latitude"/>" />
						      </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions text-right">
                	<input type="hidden" id="circleId" name="centerInfo.circleId" value="<s:property value="centerInfo.circleId"/>" />
                	<input type="hidden" id="centerId" name="centerInfo.id" value="<s:property value="centerInfo.id"/>"/>
...
function submitCenter() {
	...
	var param = {"centerInfo.centerName":centerName, "centerInfo.id":centerId, "centerInfo.cityId":cityId};
