...
<div class="block s-form">
    <form class="form-horizontal" id="adForm" name="adForm" action="<s:url value="/admin/adAdd.do" includeParams='none'/>" role="form" method="post" enctype="multipart/form-data">
        <div class="panel panel-default ">
            <div class="panel-body">
                <div class="form-group "><label class="col-sm-2 control-label text-right">广告名称:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" id="adName" name="adInfo.adName" value="">
                    </div>
                </div>
                <div class="form-group "><label class="col-sm-2 control-label text-right" value="">广告图片:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                        <div class="uploader">
                            <input type="file" class="styled" id="ad_picture_file" name="ad_picture_file">
                ...
                <div class="form-group "><label class="col-sm-2 control-label text-right">广告地址:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="adUrl" name="adInfo.adUrl" value="">
                    </div>
                </div>
...
function submitAd() {
	...
	if(!checkObjIsNull($("#ad_picture_file"))){
		top.dialog_alert("请选择上传的广告图片。");
		return false;
	}
