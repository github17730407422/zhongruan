...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">各商家月销售额，月销售单数</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="listForm" name="listForm" action="<s:url value="/admin/monthlyMOByBusiness.do" includeParams='none'/>" method="post">
<div class="block search">
    ...
    <input type="button" class="btn btn-success" onclick="excel()" value="导出excel"/>
</div>
    ...
    <div class="datatable-tasks">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="sq-center">销售总金额</th>
                <th class="sq-center">销售总单数</th>
            </tr>
            </thead>
            <tbody>
...
function excel(){
    var action="<s:url value="/admin/exportMonthlyMoByBusinessReport.do"/>";
     $('#listForm').attr("action",action);
     $('#listForm').submit();
     $('#listForm').attr("action","<s:url value="/admin/monthlyMOByBusiness.do"/>");
}
</script>
</html>