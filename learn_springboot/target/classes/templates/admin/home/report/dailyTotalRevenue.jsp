...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">每日总收入，货到付款总收入，在线支付总收入</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="listForm" name="listForm" action="<s:url value="/admin/dailyTotalRevenue.do" includeParams='none'/>" method="post">
...
<div class="block">
    <div class="datatable-tasks">
        <table class="table table-bordered">
            <thead>
            <tr>
                <th class="sq-city">年月日</th>
                <th class="sq-center">订单总收入</th>
                <th class="sq-center">在线支付总收入</th>
                <th class="sq-center">货到付款总收入</th>
            </tr>
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td class="task-desc">
                                                    ￥<s:property value="%{formatDouble(walletTotalRevenue + onlineTotalRevenue + cashTotalRevenue)}" />
                </td>
                <td class="task-desc">
                                                    ￥<s:property value="%{formatDouble(onlineTotalRevenue)}" />
                </td>
                <td class="task-desc">
                                                    ￥<s:property value="%{formatDouble(cashTotalRevenue)}" />
                </td>
            </tr>
            </s:iterator>
            </s:if>
