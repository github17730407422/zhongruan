...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">月总配送费用，月总配送单数</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="reportForm" name="reportForm" action="<s:url value="/admin/monthlyFreightOrder.do" includeParams='none'/>" method="post">
