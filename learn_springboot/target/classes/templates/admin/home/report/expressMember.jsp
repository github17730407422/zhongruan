...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">各配送人员配送单数，配送费用</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="listForm" name="listForm" action="<s:url value="/admin/expressMember.do" includeParams='none'/>" method="post">
    ...
    <div class="datatable-tasks">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="sq-center">配送人员</th>
                <th class="sq-center">配送总额</th>
            ...
            <tr>
                ...
                <td class="task-desc">
                                                    ￥<s:property value="%{formatDouble(freight)}" />
                </td>
                <td class="task-desc">
