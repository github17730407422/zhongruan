...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li class="active">添加配送人员</li>
    </ul>
</div>
<div class="block s-form">
    <form class="form-horizontal" id="memberForm" action="<s:url value="/admin/memberAdd.do" includeParams='none'/>" role="form" method="post">
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                ...
                <div class="form-group"><label class="col-sm-2 control-label text-right">配送中心名称:<font style="color: red;">*</font></label>
                    ...
                    <select class="form-control" id="centerId" name="memberInfo.centerId">
                        <s:iterator value="centerList">
                            <option value="<s:property value="id" />"><s:property value="centerName" /></option>
                        </s:iterator>
                    </select>
                    </div>
                </div>
                <div class="form-group "><label class="col-sm-2 control-label text-right">配送员姓名:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" id="memberName" name="memberInfo.memberName">
                    </div>
                </div>

                <div class="form-group "><label class="col-sm-2 control-label text-right">手机号码:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" id="mobilePhone" name="memberInfo.mobilePhone">
                    </div>
                </div>
...
function submitMember() {
	...
	var param = {"memberInfo.memberName":memberName, "memberInfo.id":0, "memberInfo.cityId":cityId, "memberInfo.centerId":centerId, "memberInfo.mobilePhone":mobile};
