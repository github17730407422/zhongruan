...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="<s:url value="/admin/ownGoodsDetails.do" includeParams='none'/>">自营商品销售明细表</a></li>
        <li class="active">自营商品月销售报表</li>
    </ul>
</div>
<form class="form-inline tab-pane" role="form" id="reportForm" name="reportForm" action="<s:url value="/admin/monthlyOwnGoods.do" includeParams='none'/>" method="post">
    ...
    <div class="datatable-tasks">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td class="task-desc">
                                                    ￥<s:property value="%{formatDouble(totalAmount)}" />
                </td>
                <td class="task-desc">
