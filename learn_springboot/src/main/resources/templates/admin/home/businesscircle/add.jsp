...
<div class="block s-form">
    <form class="form-horizontal" id="circleForm" action="<s:url value="/admin/circleAdd.do" includeParams='none'/>" role="form" method="post">
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                ...
                <div class="form-group "><label class="col-sm-2 control-label text-right">商圈名称:<font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                    	<input type="text" class="form-control" id="circleName" name="circleInfo.circleName">
                    </div>
                ...
                <div class="form-group"><label class="col-sm-2 control-label text-right">中心点位置:<font style="color: red;">*</font></label>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" id="centerPoint" name="circleInfo.centerPoint">
      <span class="input-group-btn">
        ...
        <input type="hidden" id="longitude" name="circleInfo.longitude" value="0"/>
        <input type="hidden" id="latitude" name="circleInfo.latitude" value="0"/>
      </span>
                        </div>
                    </div>
                </div>
...
function submitCircle() {
	...
	var param = {"circleInfo.circleName":circleName, "circleInfo.id":0, "circleInfo.cityId":cityId};
