...
(function (t, e) {
                ...
                t.each(this.split(","), function (e, i) {
                    if ("title" == i)a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), o = null; else {
                        ...
                        if (n[i] ? s = n[i] : me[i] && (s = function () {
                            ...
                            var l = r.theme ? q(r.buttonIcons, i) : null, c = q(r.buttonText, i), u = t("<span class='fc-button fc-button-" + i + " " + v + "-state-default'>" + (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/>" + "</span>" : c) + "</span>").click(function () {
        ...
        function s(r, a) {
            ...
            if (c)t.isFunction(c) ? (m(), c(d(E), d(T), function (t) {
                ...
                if (u) {
                    ...
                    b && (p[b] = Math.round(+E / 1e3)), D && (p[D] = Math.round(+T / 1e3)), m(), t.ajax(t.extend({}, ye, r, {data: p, success: function (e) {
                        e = e || [];
    ...
    function Z(e, n, r) {
        ...
        var L, _, q, j, I, X, J, V, U, Z, $, Q, K, te, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be = O.opt, we = O.trigger, Ce = O.renderOverlay, Me = O.clearOverlays, Ee = O.daySelectionMousedown, Te = O.cellToDate, Se = O.dateToCell, xe = O.rangeToSegments, ke = n.formatDate;
            ...
            if (Le.build(), r) {
                ...
                if (a >= 0 && Ae > a) {
                    ...
                    if (s > i) {
                        ...
                        } else o.isStart = !0, o.isEnd = !0, Te = t(nn({title: "", start: e, end: n, className: ["fc-select-helper"], editable: !1}, o)), Te.css("opacity", Ze("dragOpacity"));
    ...
    function te() {
        ...
        function o(t, e, n, r) {
            ...
            for (a = 0; h > a; a++)o = t[a], i = o.start, s = e[a], s > n && r > i && (n > i ? (l = d(n), u = !1) : (l = i, u = !0), s > r ? (c = d(r), f = !1) : (c = s, f = !0), v.push({event: o, start: l, end: c, isStart: u, isEnd: f, msLength: c - l}));
            return v.sort(B)
        }
        ...
        function s(n, r) {
            ...
            for (z[0].innerHTML = N, D = z.children(), a = 0; H > a; a++)o = n[a], i = o.event, w = t(D[a]), C = b("eventRender", i, i, w), C === !1 ? w.remove() : (C && C !== !0 && (w.remove(), w = t(C).css({position: "absolute", top: o.top, left: o.left}).appendTo(z)), o.element = w, i._id === r ? f(i, w, o) : w[0]._fci = a, U(i, w));
        ...
        function g(t, e, n) {
            ...
            e.draggable({scroll: !1, grid: [S, x], axis: 1 == T ? "y" : !1, opacity: y("dragOpacity"), revertDuration: y("dragRevertDuration"), start: function (n, r) {
    ...
    function oe() {
        ...
        function w(t, e) {
            var n, r = te();
            e.draggable({delay: 50, opacity: S("dragOpacity"), revertDuration: S("dragRevertDuration"), start: function (a, o) {
        ...
        var S = T.opt, k = T.trigger, H = T.isEventDraggable, F = T.isEventResizable, R = T.eventEnd, N = T.reportEventElement, z = T.eventElementHandlers, W = T.showEvents, A = T.hideEvents, O = T.eventDrop, _ = T.eventResize, q = T.getRowCnt, P = T.getColCnt;
        T.getColWidth;
        var I = T.allDayRow, X = T.colLeft, J = T.colRight, V = T.colContentLeft, U = T.colContentRight;
        T.dateToCell;
        var Z = T.getDaySegmentContainer, G = T.calendar.formatDates, $ = T.renderDayOverlay, Q = T.clearOverlays, K = T.clearSelection, te = T.getHoverListener, ee = T.rangeToSegments, ne = T.segmentCompare, re = T.cellToDate, ae = T.cellToCellOffset, oe = T.cellOffsetToDayOffset, le = T.dateToDayOffset, ce = T.dayOffsetToCellOffset
    }
    ...
    var he = {defaultView: "month", aspectRatio: 1.35, header: {left: "title", center: "", right: "today prev,next"}, weekends: !0, weekNumbers: !1, weekNumberCalculation: "iso", weekNumberTitle: "W", allDayDefault: !0, ignoreTimezone: !0, lazyFetching: !0, startParam: "start", endParam: "end", titleFormat: {month: "MMMM yyyy", week: "MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}", day: "dddd, MMM d, yyyy"}, columnFormat: {month: "ddd", week: "ddd M/d", day: "dddd M/d"}, timeFormat: {"": "h(:mm)t"}, isRTL: !1, firstDay: 0, monthNames: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], monthNamesShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], dayNames: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], dayNamesShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], buttonText: {prev: "<span class='fc-text-arrow'>&lsaquo;</span>", next: "<span class='fc-text-arrow'>&rsaquo;</span>", prevYear: "<span class='fc-text-arrow'>&laquo;</span>", nextYear: "<span class='fc-text-arrow'>&raquo;</span>", today: "today", month: "month", week: "week", day: "day"}, theme: !1, buttonIcons: {prev: "circle-triangle-w", next: "circle-triangle-e"}, unselectAuto: !0, dropAccept: "*", handleWindowResize: !0}, ge = {header: {left: "next,prev today", center: "", right: "title"}, buttonText: {prev: "<span class='fc-text-arrow'>&rsaquo;</span>", next: "<span class='fc-text-arrow'>&lsaquo;</span>", prevYear: "<span class='fc-text-arrow'>&raquo;</span>", nextYear: "<span class='fc-text-arrow'>&laquo;</span>"}, buttonIcons: {prev: "circle-triangle-e", next: "circle-triangle-w"}}, pe = t.fullCalendar = {version: "1.6.3"}, me = pe.views = {};
    ...
    var De = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], we = 864e5, Ce = 36e5, Me = 6e4, Ee = {s: function (t) {
        return t.getSeconds()
    }, ss: function (t) {
    ...
    pe.dateFormatters = Ee, pe.applyAll = I, me.month = J, me.basicWeek = V, me.basicDay = U, n({weekMode: "fixed"}), me.agendaWeek = $, me.agendaDay = Q, n({allDaySlot: !0, allDayText: "all-day", firstHour: 6, slotMinutes: 30, defaultEventMinutes: 120, axisFormat: "h(:mm)tt", timeFormat: {agenda: "h:mm{ - h:mm}"}, dragOpacity: {agenda: .5}, minTime: 0, maxTime: 24})
})(jQuery);